...
if ($_POST) {
    ...
    if(strlen ($codigo) > 0 && strlen ($familia) > 0 && strlen ($producto) > 0 &&
        ...
        <div class='container mt-5'>
            ...
            <a href='../views/insertProduct.php' class='btn btn-success'>
                Registrar otro
            </a>

            <a href='../views/verproductos.php' class='btn btn-primary'>
                Ver Productos
            </a>
        ...
        <div class='container mt-5'>
            ...
            <a href='../views/insertProduct.php' class='btn btn-danger'>
